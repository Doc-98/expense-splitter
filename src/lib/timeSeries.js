...
//
// (A finer 'week'/per-bill tier was tried here and on the two Graphs pages,
// but even with LineChart's curve smoothing it read as too spiky to be
// useful — reverted back to this coarser, calmer version everywhere.)
//
