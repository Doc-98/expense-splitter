...
// A page split into two regions — Settings' own "Layout" section (a
// sidebar rail + main area is the plainest, most literal "layout" there
// is), distinct from GroupsNavIcon's people-shaped glyph and PieChartIcon/
// LineChartIcon's own data-shaped ones.
export function LayoutIcon({ size = 20, ...props }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
